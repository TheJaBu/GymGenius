 ...
 */
public class panel_perfil_bd extends javax.swing.JPanel {
    ...
    public panel_perfil_bd(Interfaz.principal panelPrincipal, m_usuarios user_selec) throws SQLException, IOException {
    ...
    private void btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscarActionPerformed
        SwingUtilities.invokeLater(() -> {
            try {
                new Paneles.CambiaPanel(panelPrincipal.getPanel_central(), new panel_mostrar_usuarios(panelPrincipal, "panel_perfil_bd"));
            } catch (IOException ex) {
                ex.printStackTrace();
            }
        });
    ...
    private int getTotalUsuarios() {
        return user.getTotalUsuarios();
    }

 ...
 */
public class panel_gestionar_clase extends javax.swing.JPanel {
    ...
    public panel_gestionar_clase(Interfaz.principal panelPrincipal, m_clases clase_selec) throws IOException {
        this.panelPrincipal = panelPrincipal;
        initComponents();
        mostrarDatos(clase_selec);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Clase", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 1, 18), new java.awt.Color(153, 153, 153))); // NOI18N
        ...
        txt_horarios.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        txt_horarios.setPreferredSize(new java.awt.Dimension(150, 20));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.ipadx = 300;
        ...
        txt_descripción.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        txt_descripción.setPreferredSize(new java.awt.Dimension(150, 20));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 9;
        gridBagConstraints.ipadx = 300;
        gridBagConstraints.insets = new java.awt.Insets(10, 5, 10, 10);
        jPanel1.add(txt_descripción, gridBagConstraints);
        ...
        btn_buscar.setText("BUSCAR CLASE");
        ...
        lbl_resultado_correcto.setText("CLASE ACTUALIZADO CORRECTAMENTE");
        ...
        lbl_resultado_error.setText("NO SE A ACTUALIZADO LA CLASE");
    ...
    public void mostrarDatos(m_clases clase_s) throws IOException {
        if (clase_s != null) {
            txt_id.setText(String.valueOf(clase_s.getId()));
            txt_nombre.setText(clase_s.getNombre());
            txt_horarios.setText(clase_s.getHorarios());
            txt_descripción.setText(clase_s.getDescripcion());
            m_clases gimFoto = new m_clases();
            gimFoto = gimFoto.get_clase(clase_s.getId());
    ...
    private void btn_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actualizarActionPerformed
        try {
            m_clases clase = new m_clases();            
            clase = clase.get_clase(Integer.parseInt(txt_id.getText()));    
            if (txt_nombre == null) {
                lbl_resultado_error.setText("El nombre no puede estar vacío.");
                lbl_resultado_error.setVisible(true);
                return;
            }
            clase.setNombre(txt_nombre.getText());
            if (txt_horarios == null) {
                lbl_resultado_error.setText("La direccion no puede estar vacía.");
                lbl_resultado_error.setVisible(true);
                return;
            }
            clase.setHorarios(txt_horarios.getText());
            clase.setDescripcion(txt_descripción.getText());
            if (selectFile != null) {
                ...
                clase.setFoto(imagenFile);
            } else {
                if (clase.getFoto() == null) {
                    clase.setFoto(null);
                }
            }
            if (clase.update()) {
                ...
                lbl_resultado_error.setText("Error al actualizar la clase.");
                lbl_resultado_error.setVisible(true);
                lbl_resultado_correcto.setVisible(false);
            }
    ...
    private void btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscarActionPerformed
        SwingUtilities.invokeLater(() -> {
            try {
                new Paneles.CambiaPanel(panelPrincipal.getPanel_central(), new panel_mostrar_clases(panelPrincipal, "panel_gestionar_clase"));
            } catch (IOException ex) {
                ex.printStackTrace();
            }
        });
    ...
    private javax.swing.JTextField txt_horarios;
